...
JNIEXPORT void JNICALL Java_com_example_studyApp_demo_screenCapture_SewUtils_merge(
...
JNIEXPORT int JNICALL Java_com_example_studyApp_demo_screenCapture_SewUtils_compare(
