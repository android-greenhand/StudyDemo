...
//        Logger.d("加载网页资源 , url:" + url + " , WebView进度:" + view.getProgress());
    ...
    public void onPageFinished(WebView view, String url) {
        ...
        if (view.getProgress() == 100 && !isWebLoadFinished.get()) {
            ...
            String format2 = "javascript:%s.sendResource(JSON.stringify(window.performance.timing.domContentLoadedEventEnd-window.performance.timing.domContentLoadedEventStart));";
            String injectJs2 = String.format(format2, MyWebView.ANDROID_OBJECT_NAME);
            view.loadUrl(injectJs2);
